...
from db_queries import create_tables, insert_to_employers, insert_to_vacancies
...
def main():
    ...
    while 1:
        db_name = input('Введите слово на английском языке маленькими буквами для названия базы данных: ')
